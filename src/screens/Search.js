...
import { StyleSheet, View, SafeAreaView, Dimensions, TouchableOpacity, TextInput, Button } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.container} >
        ...
        <View style= {styles.defaultContent} >
            ...
            <Text style={{paddingHorizontal: 4, textAlign: 'center'}} h5>Recherche effectuée dans votre Bibliothèque uniquement.</Text>
